...
def verify_imports():
    ...
    req_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../Config/requirements.txt')) # get absolute path, make sure can find the requirements.txt no matter where file is run from
